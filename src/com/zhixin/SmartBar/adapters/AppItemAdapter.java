package com.zhixin.SmartBar.adapters;
...
public class AppItemAdapter extends BaseAdapter
{
    ...
    private void bind(int position, View convertView)
    {
        ...
        opTextView.setText(SmartFactory.getModeDisplayName(item.getOption()));
    ...
    public static class AppItem {
        ...
        public AppItem(String packgeName, String appName, Drawable icon) {
            ...
            this.mIcon = icon;
            this.mOption = SmartOptions.NOChange;
            this.setDisplay(this.mOption);
        }
        ...
        public void setDisplay(SmartOptions op)
        {
            this.mOption=op;
            if ( this.mOpTV != null ){
                mOpTV.setText(SmartFactory.getModeDisplayName(op));
            }
        }
